...
const orders = [
    {
        ...
        image: "https://upload.wikimedia.org/wikipedia/commons/thumb/a/a4/2019_Toyota_Corolla_Icon_Tech_VVT-i_Hybrid_1.8.jpg/1920px-2019_Toyota_Corolla_Icon_Tech_VVT-i_Hybrid_1.8.jpg",
        name: "Toyota Corolla",
        date: "5 ngay",
        fee: "5.000.000 VND",
        bill:"25.000.000 VND",
...
const OrderManagement = () => {
    return (
        ...
        {/**top section */}
            <div className="text-xl font-bold text-blue-600 pb-3 text-right px-5">{order.status}</div>
            <hr className='pb-5' />
        {/**middle section */}
            <div className="flex px-5 pb-3">
                ...
                <div className='flex-grow'>
                    <div className="flex flex-col gap-1 mx-3">
                        <p className='text-2xl text-blue-900 font-bold'>{order.name}</p>
        ...
        {/**bottom section */}
            <div className='flex gap-20 mt-2'>
                ...
                <button className="border-2 py-1 px-3 w-40 h-10 text-white bg-blue-300 hover:bg-blue-600 focus:outline-none">Thong tin chi tiet</button>
                <button className="w-auto border-2 py-1 px-3 w-40 h-10 bg-gray-300 hover:bg-gray-600 focus:outline-none">Lien he khach hang</button>
                <button className="border-2 py-1 px-3 w-40 h-10 hover:bg-gray-300 focus:outline-none">Huy don dat</button>
                </div>
            </div>
        </div>
        ))}
