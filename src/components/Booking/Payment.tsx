        ...
        <div className="flex ml-3">
            ...
            <span className="mx-60">
                <div className="px-3 justify-center">
                    <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/d/d0/QR_code_for_mobile_English_Wikipedia.svg/1024px-QR_code_for_mobile_English_Wikipedia.svg.png" className="size-60" alt="QR Img" />
                    <label className="align-middle relative left-10">Vui lòng quét mã</label>
                </div>
            </span>
        </div>
    );
