...
const Bill = () => {
  return (
    <div className="bg-gray-200 mx-5 h-[600px] py-5 text-xl">
      ...
      {/**title */}
      <h1 className="text-blue-900 font-bold py-5 text-3xl text-center">CAR4R THANK YOU!!!</h1>
      <hr />
      {/**Left container */ }
      <div className="flex gap-3 py-5 ">
      {/**Order Information */}
        <span className="w-1/2 flex flex-col gap-3 mx-5 px-5 border-blue-200 border-2 pb-3">
          <label className="text-blue-600 font-bold text-2xl pt-3">Order Info</label>
          <hr />
            ...
            <div className="flex justify-between">
              ...
              <label htmlFor="" className="text-right">5 days</label>
            </div>
        </span>

        {/**Bill section */}
        <span className="w-1/2 flex flex-col px-5 mr-5 border-blue-200 border-2 gap-3">
          <label className="text-blue-600 font-bold text-2xl pt-3">Payment Info </label>
          <hr />
            <div className="flex justify-between">
      ...
      <div className="flex justify-center gap-10 pt-10">
        <button className="text-white bg-blue-600 w-40 h-12 hover:bg-blue-900 rounded focus:outline-none ">Home</button> 
        <button className="text-white bg-blue-600 w-40 h-12 hover:bg-blue-900 rounded focus:outline-none">Export</button> 
        </div>
    </div>
    </div>
  );
