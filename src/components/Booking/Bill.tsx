...
const Bill = () => {
    return (
        <div className="ml-3">
            ...
            <div className="mt-5">
                <button className="text-white bg-blue-500 w-40 h-14 relative left-1/4">Home</button>
                <button className="text-white bg-blue-500 w-40 h-14 relative left-1/2">Import/Save</button>
            </div>
        </div>
    );
}
