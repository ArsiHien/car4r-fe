    ...
    <div className="bg-gray-200 flex h-[800px] text-xl">
      ...
      {/**image section */}
        ...
        <div className="bg-white w-1/2 my-5 mr-5">
          <div className="pl-5">
            <div>
            <h3 className="bg-blue-100 text-3xl text-center text-blue-900 font-bold py-5">Name</h3>  
            <h3 className="bg-gray-300 text-xl text-center text-white font-bold mt-3 py-3">Rating</h3>                
            </div>
        ...
        <div className="bg-white my-5 h-[300px]">
          <h3 className="text-2xl text-blue-900 font-bold py-5 pl-5">Thông tin chi tiết</h3>
        </div>
        </span>
      ...
      <div className="bg-white pb-5 pl-3">
        <h3 className="text-2xl text-blue-900 font-bold py-5">Thời gian thuê</h3>  
        <hr className="pb-5" />
        ...
        <button className="h-10 text-white bg-blue-600 text-xl mx-10 hover:bg-blue-600 rounded focus:outline-none">Order</button> 
        <button className="h-10 text-white bg-gray-600 text-xl mx-10 hover:bg-blue-600 rounded focus:outline-none">Return</button> 
        </div>
        </span>
    </div>
  );
