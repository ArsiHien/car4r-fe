            ...
            <span className="mx-3 w-3/4">
                <div className="px-3">
                    <div className="flex my-3">
                        <label className="w-16 bg-neutral-300 my-3 mr-3 text-center">Name</label>
                        <input type="text" className="w-3/4" />
                    </div>
                    <div className="flex my-3">
                        <label className="w-16 bg-neutral-300 my-3 mr-3 text-center">Phone</label>
                        <input type="text" className="w-3/4" />
                    </div>
                    <div className="flex my-3">
                        <label className="w-16 bg-neutral-300 my-3 mr-3 text-center">Address</label>
                        <input type="text" className="w-3/4" />
                    </div>
                </div>
                <div className="mx-3">
